// src/components/volunteer/VolunteerContact.jsx
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-md mx-auto text-center">
            <div className="bg-white rounded-2xl shadow-xl p-8">
              ...
              <p className="text-gray-600">We'll get back to you about volunteer opportunities soon.</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-5xl mx-auto">
          ...
          <div className="text-center mb-12">
            ...
            <p className="text-blue-100 max-w-2xl mx-auto">
              Have questions about volunteering? Fill out the form below, and our team will reach out to you.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-1 space-y-6">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <p className="text-blue-100 text-sm mb-4">Stay updated with our latest volunteer opportunities and impact stories.</p>
