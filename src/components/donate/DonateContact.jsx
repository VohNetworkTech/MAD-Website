        ...
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-12">
            ...
            <p className="text-green-100 max-w-2xl mx-auto">
              Have questions about donations? Fill out the form below, and our team will reach out to you.
            </p>
          </div>
          ...
          <div className="grid lg:grid-cols-3 gap-8">
            <div className="lg:col-span-1 space-y-6">
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <div className="space-y-3">
                  <div className="flex items-center space-x-3">
                    ...
                    <a href="tel:+919915670267" className="text-green-100 hover:text-white transition-colors text-sm">
                      +91 9915670267
                    </a>
                  </div>
                  <div className="flex items-center space-x-3">
                    <Mail className="w-4 h-4 text-green-300" />
                    <a href="mailto:contact@mad-foundation.org" className="text-green-100 hover:text-white transition-colors text-sm">
              ...
              <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
                ...
                <p className="text-green-100 text-sm mb-4">Stay updated with our latest initiatives, events, and impact stories.</p>
                ...
                <div className="space-y-4">
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <input
                      ...
                      className="px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all text-sm"
                      required
                    />
                    <input
                      type="tel"
                  ...
                  <input
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all text-sm"
                    required
                  />
                  ...
                  <textarea
                    ...
                    onChange={handleInputChange}
                    className="w-full px-3 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent outline-none transition-all resize-none text-sm"
                    required
                  ></textarea>
