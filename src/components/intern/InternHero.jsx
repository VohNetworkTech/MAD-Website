        ...
        <div className="max-w-5xl mx-auto text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl md:text-2xl text-blue-100 leading-relaxed max-w-4xl mx-auto">
              Gain hands-on experience, contribute to meaningful causes, and develop new skills while supporting inclusive education and advocacy
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
              ...
              <div className="text-blue-200">& Grow</div>
            </div>
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
              <Users className="w-12 h-12 text-yellow-400 mx-auto mb-4" />
              <div className="text-3xl font-bold mb-2">Make</div>
              <div className="text-blue-200">Impact</div>
            </div>
            <div className="bg-white/10 backdrop-blur-lg rounded-2xl p-6 border border-white/20">
              <Target className="w-12 h-12 text-orange-400 mx-auto mb-4" />
              <div className="text-3xl font-bold mb-2">Gain</div>
